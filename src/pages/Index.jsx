...
const Index = () => {
  return (
    <div className="text-center">
      ...
      <ThreeDVisualization />
      <h2 className="text-2xl font-semibold mb-2">Visualização de Orçamento</h2>
      <BudgetVisualization />
      <h2 className="text-2xl font-semibold mb-2">Curva S</h2>
      <SCurveVisualization />
      <h2 className="text-2xl font-semibold mb-2">Cronograma Gantt</h2>
      <GanttChart />
    </div>
  );
};
